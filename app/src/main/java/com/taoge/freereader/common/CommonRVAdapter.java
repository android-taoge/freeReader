 ...
 * @date 2016/7/21.
 */
public abstract class CommonRVAdapter<T> extends RecyclerView.Adapter<CommonRVHolder> implements DataHelper<T> {
    ...
    public CommonRVAdapter(Context context, List<T> list, int... layoutIds) {
    ...
    @Override
    public CommonRVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CommonRVHolder viewHolder = (CommonRVHolder) view.getTag();
        if (viewHolder == null || viewHolder.getLayoutId() != layoutId) {
            viewHolder = new CommonRVHolder(mContext, layoutId, view);
            return viewHolder;
        }
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(CommonRVHolder holder, int position) {
    ...
    protected abstract void onBindData(CommonRVHolder viewHolder, int position, T item);
